<template>
<v-content>
    <div class="wrapper"  ref="drawing"></div>
    {{ winsize }}
</v-content>
...
export default {
  ...
  methods:{
    ...
    draw(){
      const draw = svglib(this.$refs.drawing).size(this.$refs.drawing.clientWidth, this.$refs.drawing.clientHeight).panZoom({zoomMin: 0.5, zoomMax: 20})
